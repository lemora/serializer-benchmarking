...
public class AvroTestobjBenchmarker {

    private Avro_Msg avro_msg_rw00;
    private byte[] smsg_binary_rw00;

    private Avro_Msg_rw01 avro_msg_rw01;
    private byte[] smsg_binary_rw01;

    private Avro_Msg_rw02 avro_msg_rw02;
    private byte[] smsg_binary_rw02;

    private Avro_Msg_rw03 avro_msg_rw03;
    private byte[] smsg_binary_rw03;

    private Avro_Msg_rw04 avro_msg_rw04;
    private byte[] smsg_binary_rw04;

    private Avro_Msg_rw05 avro_msg_rw05;
    private byte[] smsg_binary_rw05;

    @Setup
    public void setUp() {
        // --- Msg ---
        avro_msg_rw00 = SerializerAvro.msgToAvro_Msg(new Msg());
        smsg_binary_rw00 = SerializerAvro.serAvro_binary_Msg(avro_msg_rw00);

        // --- Msg_rw01 ---
        avro_msg_rw01 = SerializerAvro.msgToAvro_MsgRw01(new Msg_rw01());
        smsg_binary_rw01 = SerializerAvro.serAvro_binary_MsgRw01(avro_msg_rw01);

        // --- Msg_rw02 ---
        avro_msg_rw02 = SerializerAvro.msgToAvro_MsgRw02(new Msg_rw02());
        smsg_binary_rw02 = SerializerAvro.serAvro_binary_MsgRw02(avro_msg_rw02);

        // --- Msg_rw03 ---
        avro_msg_rw03 = SerializerAvro.msgToAvro_MsgRw03(new Msg_rw03());
        smsg_binary_rw03 = SerializerAvro.serAvro_binary_MsgRw03(avro_msg_rw03);

        // --- Msg_rw04 ---
        avro_msg_rw04 = SerializerAvro.msgToAvro_MsgRw04(Msg_rw04.createTestInstance());
        smsg_binary_rw04 = SerializerAvro.serAvro_binary_MsgRw04(avro_msg_rw04);

        // --- Msg_rw05 ---
        avro_msg_rw05 = SerializerAvro.msgToAvro_MsgRw05(new Msg_rw05());
        smsg_binary_rw05 = SerializerAvro.serAvro_binary_MsgRw05(avro_msg_rw05);
    }
...
// ------ Msg ------
    ...
    public byte[] avro_rw00_ser() {
        return SerializerAvro.serAvro_binary_Msg(avro_msg_rw00);
    }

    @Benchmark
    public Object avro_rw00_deser() {
        try {
            return SerializerAvro.deserToAvro_binary_Msg(smsg_binary_rw00);
        } catch (IOException e) {
            e.printStackTrace();
        }
        return null;
...
// ------ Msg_rw01 ------
    ...
    public byte[] avro_rw01_ser() {
        return SerializerAvro.serAvro_binary_MsgRw01(avro_msg_rw01);
    }

    @Benchmark
    public Object avro_rw01_deser() {
        try {
            return SerializerAvro.deserToAvro_binary_MsgRw01(smsg_binary_rw01);
        } catch (IOException e) {
            e.printStackTrace();
        }
        return null;
...
// ------ Msg_rw02 ------
    ...
    public byte[] avro_rw02_ser() {
        return SerializerAvro.serAvro_binary_MsgRw02(avro_msg_rw02);
    }

    @Benchmark
    public Object avro_rw02_deser() {
        try {
            return SerializerAvro.deserToAvro_binary_MsgRw02(smsg_binary_rw02);
        } catch (IOException e) {
            e.printStackTrace();
        }
        return null;
...
// ------ Msg_rw03 ------
    ...
    public byte[] avro_rw03_ser() {
        return SerializerAvro.serAvro_binary_MsgRw03(avro_msg_rw03);
    }

    @Benchmark
    public Object avro_rw03_deser() {
        try {
            return SerializerAvro.deserToAvro_binary_MsgRw03(smsg_binary_rw03);
        } catch (IOException e) {
            e.printStackTrace();
        }
        return null;
...
// ------ Msg_rw04 ------
    ...
    public byte[] avro_rw04_ser() {
        return SerializerAvro.serAvro_binary_MsgRw04(avro_msg_rw04);
    }

    @Benchmark
    public Object avro_rw04_deser() {
        try {
            return SerializerAvro.deserToAvro_binary_MsgRw04(smsg_binary_rw04);
        } catch (IOException e) {
            e.printStackTrace();
        }
        return null;
...
// ------ Msg_rw05 ------
    ...
    public byte[] avro_rw05_ser() {
        return SerializerAvro.serAvro_binary_MsgRw05(avro_msg_rw05);
    }

    @Benchmark
    public Object avro_rw05_deser() {
        try {
            return SerializerAvro.deserToAvro_binary_MsgRw05(smsg_binary_rw05);
        } catch (IOException e) {
            e.printStackTrace();
        }
        return null;
